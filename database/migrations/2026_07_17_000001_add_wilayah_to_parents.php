...
/**
 * Tambah kolom alamat wilayah berjenjang ke parents (T2.1).
 * Simpan id (kode BPS, untuk relasi/filter) + nama snapshot (agar label alamat
 * tetap terbaca walau data referensi berubah). Semua nullable — kolom `alamat`
 * lama tetap dipakai untuk detail jalan/RT/RW.
 */
