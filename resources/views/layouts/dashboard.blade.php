...
<body class="font-sans antialiased bg-slate-50 text-slate-800" x-data="{ sidebarOpen: false }">
    ...
    @php
        ...
        $authUser = auth()->user();
        $activeRole = $authUser->role;              // 'ortu' | 'admin' | 'guru'
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden md:flex flex-col w-72 bg-slate-900 text-slate-300 shrink-0 border-r border-slate-800">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                @if ($activeRole === 'ortu')
                    <a href="{{ route('ortu.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.dashboard') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4zM14 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4z" />
                        </svg>
                        <span>Dashboard</span>
                    </a>
                    <a href="{{ route('ortu.register') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.register') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span>Daftar Murid Baru</span>
                    </a>
                    <a href="{{ route('ortu.status') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.status') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                        </svg>
                        <span>Status Pendaftaran</span>
                    </a>
                    <a href="{{ route('ortu.payments') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.payments') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                        </svg>
                        <span>Pembayaran & SPP</span>
                    </a>
                    <a href="{{ route('ortu.children') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.children') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                    ...
                    <a href="{{ route('ortu.profile') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.profile') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                    ...
                    <a href="{{ route('ortu.account') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.account') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                        <span>Pengaturan Akun</span>
                    </a>
                    <a href="{{ route('ortu.password') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.password') ? 'bg-sky-500 text-white shadow-lg shadow-sky-500/10' : 'hover:bg-slate-800 text-slate-400 hover:text-white' }} transition-all">
                ...
                @if ($activeRole === 'admin')
                    @php
                        ...
                        $ppdbActive = request()->routeIs('admin.registrations*') || request()->routeIs('admin.daftar-ulang') || request()->routeIs('admin.calon-murid');
                    ...
                    <div x-data="{ open: {{ $ppdbActive ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-cloak class="mt-1 ml-4 pl-3 border-l border-slate-800 space-y-1">
                            ...
                            <a href="{{ route('admin.calon-murid') }}" class="flex items-center px-4 py-2 rounded-lg text-xs font-semibold {{ request()->routeIs('admin.calon-murid') ? 'text-white' : 'text-slate-400 hover:text-white' }}"><span>Calon Murid</span></a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: {{ request()->routeIs('admin.data.students') || request()->routeIs('admin.users') || request()->routeIs('admin.students.import*') ? 'true' : 'false' }} }">
                        <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('admin.data.students') || request()->routeIs('admin.users') || request()->routeIs('admin.students.import*') ? $aOn : $aOff }} transition-all">
                            <span class="flex items-center space-x-3">
                        ...
                        <div x-show="open" x-cloak class="mt-1 ml-4 pl-3 border-l border-slate-800 space-y-1">
                            <a href="{{ route('admin.data.students') }}" class="block px-4 py-2 rounded-lg text-xs font-semibold {{ request()->routeIs('admin.data.students') || request()->routeIs('admin.users') ? 'text-white' : 'text-slate-400 hover:text-white' }}">Daftar Murid</a>
                            <a href="{{ route('admin.students.import') }}" class="block px-4 py-2 rounded-lg text-xs font-semibold {{ request()->routeIs('admin.students.import*') ? 'text-white' : 'text-slate-400 hover:text-white' }}">Import CSV</a>
                        </div>
                    </div>
    ...
    <div x-show="sidebarOpen" class="fixed inset-0 z-50 flex md:hidden" role="dialog" aria-modal="true" x-cloak>
        ...
        <div class="relative flex flex-col w-full max-w-xs bg-slate-900" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                @if ($activeRole === 'ortu')
                    <a href="{{ route('ortu.dashboard', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.dashboard') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Dashboard</span>
                    </a>
                    <a href="{{ route('ortu.register', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.register') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Daftar Murid Baru</span>
                    </a>
                    <a href="{{ route('ortu.status', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.status') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Status Pendaftaran</span>
                    </a>
                    <a href="{{ route('ortu.payments', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.payments') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Pembayaran & SPP</span>
                    </a>
                    <a href="{{ route('ortu.children', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.children') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Data Anak</span>
                    </a>
                    <a href="{{ route('ortu.profile', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.profile') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Profil Orang Tua</span>
                    </a>
                    <a href="{{ route('ortu.account', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.account') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Pengaturan Akun</span>
                    </a>
                    <a href="{{ route('ortu.password', ) }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('ortu.password') ? 'bg-sky-500 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Ganti Password</span>
                    </a>
                @elseif ($activeRole === 'admin')
                    ...
                    <a href="{{ route('admin.calon-murid') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('admin.calon-murid') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>PPDB — Calon Murid</span>
                    </a>
                    ...
                    <a href="{{ route('admin.students.import') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('admin.students.import*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800' }}">
                        <span>Data Murid — Import CSV</span>
                    </a>
...
<script>
// ponytail: block non-digit char entry on inputmode="numeric" inputs (no_hp,nik,nisn,nis,nuptk)
document.addEventListener('keydown', e => {
    if (e.target.matches('[inputmode="numeric"]') && e.key.length === 1 && !/^\d$/.test(e.key) && e.key !== 'Backspace' && e.key !== 'Delete' && e.key !== 'Tab' && !e.ctrlKey && !e.metaKey) {
        e.preventDefault();
    }
});
// also strip non-digit on paste/drag — trust but verify at the DOM level
document.addEventListener('input', e => {
    if (e.target.matches('[inputmode="numeric"]') && /\D/.test(e.target.value)) {
